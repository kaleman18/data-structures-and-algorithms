...
const maxInArray = (arr) => {
  ...
  for(let i = 0; i < arr.length; i++){
    // this is old, dont use this anymore
    // if(arr[i] > max){
    //   max = arr[i];
    // }
...
const getCourseKeys = (obj) => {
  // Solution code here...
  let courseInfoArray = Object.keys(obj);
...
const checkValues = (obj, value) => {
  // Solution code here...
  let stuff = Object.is(obj.class, value);
  return stuff;
};
...
const updateNumbers = (obj) => {
  // Solution code here...
  let array = [];
  Object.keys(obj).forEach(key => array.push(`${key}: ${obj[key]}`));
